...
function getTokenEffectWidth()
	local tokenWidth = 58; -- default original condition icon width, cannot go above this unless I increase size of graphics
	...
	elseif tokenSizeSelection == 'option_medium' then
		tokenWidth = 58;
	-- the below will not be usable unless enlargened icon graphics are used to replace the original, currently not part of the menu options		
